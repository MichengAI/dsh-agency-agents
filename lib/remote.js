import { A as settingsNamespaceCompat, D as expertEditSchema, E as customExpertInputSchema, O as formatHost, T as catalogSnapshotSchema, h as readLocalizedExpertPrompt, k as readHostLocale, m as readExpertPrompt, t as AGENCY_PERSONA_SERVICE, w as AGENCY_LIBRARY_SERVICE } from "./src-17DCjD_2.js";
import { z } from "zod";
...
const customSlugParameter = {
	...
	codec: {
		mode: "strict",
		typeSymbol: "string",
		schema: z.string().regex(/^custom-[0-9a-f-]{36}$/u)
	}
};
...
let AgencyAgentsRemote = (() => {
	...
	let _restoreCustomExpert_decorators;
	...
	return class AgencyAgentsRemote extends _classSuper {
		static {
			...
			_restoreCustomExpert_decorators = [Remote("restoreCustomExpert")];
			...
			__esDecorate(this, null, _restoreCustomExpert_decorators, {
				kind: "method",
				name: "restoreCustomExpert",
				static: false,
				private: false,
				access: {
					has: (obj) => "restoreCustomExpert" in obj,
					get: (obj) => obj.restoreCustomExpert
				},
				metadata: _metadata
			}, null, _instanceExtraInitializers);
		...
		async restoreCustomExpert(slug, expectedRevision) {
