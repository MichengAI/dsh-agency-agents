...
function readHostLocale(ctx) {
	try {
		const section = ctx.settings?.get?.(settingsNamespace("locale"));
...
//#endregion
export { readHostLocale as a, ZH_DIVISION as c, matchDivision as i, ZH_NAME as l, localizedExpertDescription as n, renderExpertList as o, localizedExpertName as r, renderSummonResults as s, formatHost as t };
