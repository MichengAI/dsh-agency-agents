...
export const TEAM_EN = {
  ...
  '{0}副本': '{0} copy', '团队目标：{0}': 'Team goal: {0}', '共同约束：{0}': 'Shared constraints: {0}', '交付要求：{0}': 'Deliverables: {0}',
  '复制失败，请重试。': 'Copy failed. Please retry.', '专家团': 'Expert teams', '专家': 'Experts', '专家库类型': 'Expert library view',
  ...
  '正在加载专家团…': 'Loading teams…', '{0} 位专家': '{0} experts', '更多': 'More', '查看详情': 'View details', '已复制': 'Copied',
  '复制提示词': 'Copy prompt', '没有找到专家团': 'No teams found', '换个关键词，或创建自己的专家团。': 'Try another keyword or create your own team.',
