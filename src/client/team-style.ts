...
.aag-library-navigation{display:flex;align-items:center;justify-content:space-between;gap:16px}.aag-library-summary{display:flex;align-items:center;gap:12px;flex-wrap:wrap;justify-content:flex-end;font-size:12px}.aag-library-navigation>.aag-library-tabs{flex:1;width:100%;min-width:0;border-bottom:0}.aag-library-shell>.aag-section,.aag-library-shell>div>.aag-section{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center}.aag-library-shell>.aag-section>*,.aag-library-shell>div>.aag-section>*{grid-column:1/-1}.aag-library-shell .aag-section>.aag-toolbar{grid-column:2;grid-row:1}.aag-library-shell .aag-section>.aag-custom-tabs{grid-column:1;grid-row:1}.aag-library-shell .aag-section>.aag-custom-tabs{gap:8px}@container(max-width:420px){.aag-library-shell .aag-section>.aag-toolbar{grid-column:1/-1;grid-row:2;justify-content:flex-end}.aag-library-shell .aag-section>.aag-custom-tabs{grid-column:1/-1}.aag-library-summary{gap:4px 8px}}
