...
export const zh = {
  ...
  'settings.filter.development': '开发',
  'settings.filter.design': '设计',
  'settings.filter.product': '产品',
  'settings.filter.research': '研究',
  'settings.filter.writing': '写作',
...
export const en = {
  ...
  'settings.filter.development': 'Development',
  'settings.filter.design': 'Design',
  'settings.filter.product': 'Product',
  'settings.filter.research': 'Research',
  'settings.filter.writing': 'Writing',
  'settings.filter.option': '{name} ({count})',
