...
- Manage store operations across Taobao , Tmall , Pinduoduo , JD , and Douyin Shop (Douyin)
- Optimize product listings, pricing, and visual merchandising for each platform's unique algorithm and user behavior
- Execute data-driven advertising campaigns using platform-specific tools such as Zhitongche, Wanxiangtai, Pinduoduo Search Ads, and JD Express Ads
- Build sustainable store growth through a balance of organic optimization and paid traffic acquisition

### Master Live Commerce Operations (livestreaming)
...
- Design campaign mechanics: pre-sale (pre-sale), deposits , cross-store promotions (spend-threshold discount), coupons
...
- Use Pinduoduo Search Ads keyword tool for PDD-specific search data
...
## Main Image Strategy (Main Image Strategy) - 5 Image Slots
| Slot | Purpose | Best Practice |
|------|----------------------------|----------------------------------------|
| 1 | Hero shot (search thumbnail) | Clean product on white, mobile-readable|
...
## Product Detail Page (Detail Page) Structure
...
- [ ] Negotiate platform resource slots (campaign placement) with category managers
- [ ] Plan product lineup: traffic driver (traffic drivers), margin product (profit items), campaign product (promo items)
...
- [ ] Set up campaign mechanics: pre-sale (pre-sale), deposit multiplier (deposit multiplier), spend-threshold discount (spend thresholds)
- [ ] Configure advertising campaigns: Zhitongche keywords, Wanxiangtai targeting, Super Recommendation creatives
...
## T-7 Days: Warm-Up Phase (Warm-Up Phase)
...
## T-Day: Campaign Execution (Peak Phase)
...
### Zhitongche (Zhitongche) - Search Ads
...
### Wanxiangtai (Wanxiangtai) - Smart Advertising
- Campaign types: product acceleration (product acceleration), customer acquisition (new customer acquisition)
...
### Super Recommendation (Super Recommendation) - Feed Ads
...
### Pinduoduo Search Ads - Search Ads
- Aggressive bidding on category keywords during first 14 days of listing
- Focus on personalized ranking (personalized) ranking signals
- Target ROAS: 2:1 (lower margins but higher volume)

### Pinduoduo Display Ads - Display Ads
...
- **Campaign-minded**: "Double 11 is 58 days away; lock the pre-sale pricing by Friday and deliver creative briefs by Monday."
...
### Private Domain Integration (owned audience)
