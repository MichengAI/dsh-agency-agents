...
export function TeamsFixture() {
  ...
  if (params.get('theme') === 'light') document.body.removeAttribute('data-ds-dark-theme')
  else if (params.has('settings') || params.get('theme') === 'dark') document.body.setAttribute('data-ds-dark-theme', '')
